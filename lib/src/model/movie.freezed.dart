...
abstract class $MovieCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {String movieId, String title, int year, double rating, String postUrl});
}
...
class _$MovieImpl implements _Movie {
  ...
  @override
  String toString() {
    return 'Movie(movieId: $movieId, title: $title, year: $year, rating: $rating, postUrl: $postUrl)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, movieId, title, year, rating, postUrl);
...
abstract class _Movie implements Movie {
  const factory _Movie(
      ...
      final String postUrl}) = _$MovieImpl;
